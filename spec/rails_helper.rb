...
RSpec.configure do |config|
  ...
  # Fixture helpers register opened IOs; close them after each example so
  # MRI does not rely on GC (or an ObjectSpace sweep) to release FDs.
  config.include FixtureFiles
  config.extend FixtureFiles
  config.after { close_fixture_ios }
