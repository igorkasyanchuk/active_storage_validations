...
RSpec.shared_examples "works with if option" do
  subject(:model) { validator_test_class::WithIf.new(params) }
  ...
  context "when the :if condition is a method" do
  ...
  context "when the :if condition is a Proc" do
    context "and the condition is met" do
