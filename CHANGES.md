...
- 4.0.0
  ...
  - **FEATURES**
    - Add `#except_on` matcher option to support Rails `:except_on` validation option (https://github.com/igorkasyanchuk/active_storage_validations/issues/380)
  - **OTHER**
...
- 3.0.6
  ...
  - Fix validation of multiple new attachables with nil blob ids (https://github.com/igorkasyanchuk/active_storage_validations/pull/422) @tmnb
