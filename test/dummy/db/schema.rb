...
ActiveRecord::Schema.define do
  ...
  %w[proc_option invalid_content_type_with invalid_content_type_in invalid_content_type_jpg valid_ct_ole_storage invalid_extension regex_option invalid_spoof_protection].each do |invalid_case|
