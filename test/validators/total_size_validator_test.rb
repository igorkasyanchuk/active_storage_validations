      ...
      %w(value proc).each do |value_type|
        describe "#{value_type} validator" do
          ...
          describe 'when provided with the exact total_size specified in the model validations' do
            ...
            it { is_expected_to_have_error_message("total_file_size_not_less_than", error_options: error_options) }
      ...
      %w(value proc).each do |value_type|
        describe "#{value_type} validator" do
          ...
          describe 'when provided with a higher total_size than the total_size specified in the model validations' do
            ...
            it { is_expected_not_to_be_valid }
            it { is_expected_to_have_error_message("total_file_size_not_less_than_or_equal_to", error_options: error_options) }
            it { is_expected_to_have_error_options(error_options) }
          end
        end
      end
      ...
      %w(value proc).each do |value_type|
        describe "#{value_type} validator" do
          describe 'when provided with a lower total_size than the total_size specified in the model validations' do
            ...
            it { is_expected_not_to_be_valid }
            it { is_expected_to_have_error_message("total_file_size_not_greater_than", error_options: error_options) }
            it { is_expected_to_have_error_options(error_options) }
          end
      ...
      %w(value proc).each do |value_type|
        describe "#{value_type} validator" do
          describe 'when provided with a lower total_size than the total_size specified in the model validations' do
            ...
            it { is_expected_not_to_be_valid }
            it { is_expected_to_have_error_message("total_file_size_not_greater_than_or_equal_to", error_options: error_options) }
            it { is_expected_to_have_error_options(error_options) }
          end
      ...
      %w(value proc).each do |value_type|
        describe "#{value_type} validator" do
          describe 'when provided with a lower total_size than the total_size specified in the model validations' do
            ...
            it { is_expected_not_to_be_valid }
            it { is_expected_to_have_error_message("total_file_size_not_between", error_options: error_options) }
            it { is_expected_to_have_error_options(error_options) }
          end
